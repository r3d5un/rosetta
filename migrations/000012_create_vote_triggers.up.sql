...
CREATE TRIGGER trigger_post_vote_sum_on_insert
    AFTER INSERT
    ON forum.post_votes
    FOR EACH ROW
EXECUTE FUNCTION update_post_likes();

CREATE TRIGGER trigger_post_vote_sum_on_update
    AFTER UPDATE
    ON forum.post_votes
    FOR EACH ROW
EXECUTE FUNCTION update_post_likes();

CREATE TRIGGER trigger_post_vote_sum_on_delete
    AFTER DELETE
    ON forum.post_votes
    FOR EACH ROW
EXECUTE FUNCTION update_post_likes();
...
CREATE TRIGGER trigger_thread_vote_sum_on_insert
    AFTER INSERT
    ON forum.thread_votes
    FOR EACH ROW
EXECUTE FUNCTION update_thread_likes();

CREATE TRIGGER trigger_thread_vote_sum_on_update
    AFTER UPDATE
    ON forum.thread_votes
    FOR EACH ROW
EXECUTE FUNCTION update_thread_likes();

CREATE TRIGGER trigger_thread_vote_sum_on_delete
    AFTER DELETE
    ON forum.thread_votes
    FOR EACH ROW
EXECUTE FUNCTION update_thread_likes();
